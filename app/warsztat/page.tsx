  ...
  const services = [
    {
      ...
      description: "Kompleksowa diagnostyka obd2",
      icon: Gauge,
    },
    {
      title: "Serwis Silnika",
      description: "Naprawa i konserwacja silnika",
      icon: Wrench,
    },
    {
      title: "Wymiana Olejów",
      description: "Wymiana olejów i filtrów",
      icon: Droplets,
    },
    {
      title: "Serwis Elektyki",
      description: "Naprawa elektyki samochodowej",
      icon: Zap,
    },
    {
      title: "Naprawa Paliwa",
      description: "Serwis systemu paliwowego",
      icon: Hammer,
    },
    {
      title: "Regulacje",
      description: "Regulacje zawieszenia i ustawienia",
      icon: Sliders,
    },
  ]
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Kompleksowe usługi serwisowe dla Twojego pojazdu z gwarancją na wszystkie prace
            </p>
